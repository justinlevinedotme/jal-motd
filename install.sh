...
# Automate adding update counts to the bottom of the motd
# Create /etc/update-motd-static.d/
sudo mkdir -p /etc/update-motd-static.d/

# Copy file to /etc/update-motd-static.d using the provided URL
...
# Copy systemd files to /etc/systemd/system using the provided URLs
